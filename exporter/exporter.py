...
def main():
    ...
    parser.add_argument(
        "--output_dir", help="Output directory.", type=str, default="./out"
    )
    parser.add_argument(
        "--image_topic",
        help="Image topic.",
        type=str,
        default="/pylon_camera_node/image_raw",
    )
    parser.add_argument(
        "--gps_topic", help="Gps topic.", type=str, default="/ublox_gps/fix"
    )
    parser.add_argument(
        "--gps_time_topic",
        help="Gps time topic.",
        type=str,
        default="/ublox_gps/navpvt",
    )
